...
import org.androidtown.multimemo.stage04.VoiceRecorder.OnStateChangedListener;
 ...
 * @date 2011-07-01
 */
public class VoiceRecordingActivity extends Activity implements OnStateChangedListener{
	...
	public void startVoiceRecorging()
    {
    	// start recording
		voiceRecordingStart();

		mStartStopBtn.setText("녹음 중지");
