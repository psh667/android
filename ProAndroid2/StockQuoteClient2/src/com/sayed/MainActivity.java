...
import com.sayed.IStockQuoteService;
...
private Button   bindBtn   = null; private Button   callBtn = null; private Button   unbindBtn   = null;
...
Toast.makeText(MainActivity.this, "서비스에서 가져온 값은 "+response+"이다.",
...
Log.v(TAG, "onServiceDisconnected() 호출됨");
stockService = null;
}
};
}
